...
import { ReportHeader } from '@/pages/reports/components/ReportHeader';
  ...
  return (
    <MainLayout title="ফি রিপোর্ট">
      <div className="space-y-6">
        ...
        {/* Reports Tabs */}
        <Tabs defaultValue="student-report" className="print-area erp-report">
                ...
                {!selectedStudentId ? (
                  ...
                  <div className="space-y-6" ref={reportRef}>
                    ...
                    <div className="print-only">
                      <ReportHeader 
                        title="শিক্ষার্থী ফি রিপোর্ট"
                        academicYear={getSelectedYearName()}
                      />
                    </div>
          ...
          <TabsContent value="class-report">
            <Card>
              ...
              <CardContent>
                <div className="print-only">
                  <ReportHeader 
                    title="শ্রেণী ভিত্তিক আদায় রিপোর্ট"
                    month={selectedMonth ? months.find(m => m.value === selectedMonth)?.label : undefined}
                  />
                </div>
                {!selectedClass ? (
                  <p className="text-center text-muted-foreground py-8">
          ...
          <TabsContent value="defaulters">
            <Card>
              ...
              <CardContent>
                <div className="print-only">
                  <ReportHeader title="বকেয়া তালিকা" />
                </div>
                {defaultersLoading ? (
                  <div className="space-y-2">
                    {Array.from({ length: 5 }).map((_, i) => (
