  ...
  return (
    <div className="overflow-hidden">
      ...
      {statsSection?.is_enabled && statsItems.length > 0 && (
        <section className="py-16 md:py-20 bg-gradient-to-r from-[#4B0082] to-[#6B2D8B] text-white relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {statsItems.map((item: any, index: number) => (
                <div key={index} className="text-center">
                  <div className="text-4xl md:text-5xl font-bold mb-2 text-[#00D4FF] drop-shadow-lg">
                    {item.value}
                  </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#4B0082] to-[#6B2D8B] text-white relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-[#00D4FF]/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
        </div>
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Button asChild size="lg" className="bg-[#00D4FF] text-[#0D0221] hover:bg-[#00D4FF]/90 shadow-lg shadow-[#00D4FF]/30">
